...
//    List<List<Integer>> bottomtraversal = levelOrderBottom(root);
//    System.out.println(bottomtraversal);
    ...
    root1.left.right.left.right = new Node(7);

    MorisPreorderTraversal(root1);
    MorisInorderTraversal(root1);
  }
