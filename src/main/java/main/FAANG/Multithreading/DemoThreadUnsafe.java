...
public class DemoThreadUnsafe {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        Thread thread1 = new Thread(new Runnable() {
            ...
            public void run() {
                for (int i = 0; i < 100; i++) {
                   ...
                   // badCounter.printFinalCounterValue("Increment");
        ...
        Thread thread2 = new Thread(new Runnable() {
            ...
            public void run() {
                for (int i = 0; i < 100; i++) {
                  ...
                  //  badCounter.printFinalCounterValue("Decrement");
                    DemoThreadUnsafe.sleepRandomlyForLessThan10Secs();
                }
            }
        });
        ...
        badCounter.printFinalCounterValue("Main");
    }
...
class ThreadUnsafeCounter {
    ...
    void printFinalCounterValue(String flag) {
        System.out.println(flag+" "+"counter is: " + count);
    }
}
